...
export { detectFeatures, getDefaultConfig, mergeFeatureFlags, parse, parseAspectRatio, parseRangeString, parseSlide, prettify, prettifySlide, resolveConfig, resolveFonts, scanMonacoModules, stringify, stringifySlide, verifyConfig } from './core.mjs';
...
declare function load(userRoot: string, filepath: string, content?: string): Promise<LoadedSlidevData>;
declare function save(markdown: SlidevMarkdown): Promise<void>;
