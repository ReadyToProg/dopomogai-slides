import{d as _,aj as u,z as h,o as n,e as l,f as t,t as s,B as c,F as f,ag as g,aa as v,b as x,g as b}from"../modules/vue-H4SylcjB.js";import{a as y,u as N,z as m}from"../index-CkbH8phE.js";import{_ as k}from"./NoteDisplay.vue_vue_type_style_index_0_lang-BeG0X4sx.js";import"../modules/shiki-vAJ4vxrb.js";const w={id:"page-root"},B={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},z={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},j={key:0,class:"border-main mb-8"},A=_({__name:"print",setup(C){const{slides:d,total:p}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
